<section class="ftco-section bg-light">
    	<div class="container">
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
          	<span class="subheading">Paket &amp; Pelatihan</span>
    		...
    		<div class="row">
	          ...
	          <div class="block-7">
	            <div class="text-center">
	            	<span class="excerpt d-block">Web Design</span>
	        ...
	        <div class="col-md-6 col-lg-3 ftco-animate">
	          <div class="block-7">
	            <div class="text-center">
            	<span class="excerpt d-block">Honda Academy</span>
	        ...
	        <div class="col-md-6 col-lg-3 ftco-animate">
	          <div class="block-7">
	            <div class="text-center">
	            	<span class="excerpt d-block">Cisco Networking</span>
	        ...
	        <div class="col-md-6 col-lg-3 ftco-animate">
	          <div class="block-7">
	            <div class="text-center">
	            	<span class="excerpt d-block">Oracle Database Training</span>

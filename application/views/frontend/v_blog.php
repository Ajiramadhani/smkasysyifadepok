<?php $background = $this->db->query("SELECT * FROM background WHERE background_kategori='blog' ORDER BY background_id")->result();
  ...
  <div class="container">
    <div class="row no-gutters slider-text align-items-end">
      <div class="col-md-9 ftco-animate pb-5">
        <p class="breadcrumbs mb-2"><span class="mr-2"><a href="<?php echo base_url(); ?>">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Blog <i class="ion-ios-arrow-forward"></i></span></p>
          ...
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              ...
              <div class="text p-4">
                ...
                <h3 class="heading"><a href="<?php echo base_url() . $a->artikel_slug ?>"><?php echo word_limiter($a->artikel_konten, 10); ?></a></h3>
              </div>
            </div>
          </div>
        <?php } ?>

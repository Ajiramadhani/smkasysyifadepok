<div class="content-wrapper">
	...
	<section class="content">
		...
		<form method="post" action="<?php echo base_url('dashboard/siswa_tambah') ?>" enctype="multipart/form-data">
											<div class="row">
												<div class="col-md-6">
													...
													<select class="form-control" name="agama">
														<label class="label" for="agama">Agama</label>
															...
															<?php foreach($agama as $k){ ?>
																<option <?php if(set_value('agama') == $k->agama_id){echo "selected='selected'";} ?> value="<?php echo $k->agama_id ?>"><?php echo $k->agama_nama; ?></option>
															<?php } ?>
													</select>
													...
													<select class="form-control" name="jurusan">
														<label class="label" for="jurusan">Program Keahlian</label>
															...
															<?php foreach($jurusan as $k){ ?>
																<option <?php if(set_value('jurusan') == $k->jurusan_id){echo "selected='selected'";} ?> value="<?php echo $k->jurusan_id ?>"><?php echo $k->jurusan_nama; ?></option>
															<?php } ?>
													</select>
													...
													<div class="form-group">
														...
														<option value="">- Jenis Kelamin -</option>
															<?php foreach($gender as $k){ ?>
																<option <?php if(set_value('gender') == $k->gender_id){echo "selected='selected'";} ?> value="<?php echo $k->gender_id ?>"><?php echo $k->gender_nama; ?></option>
															<?php } ?>
														</select>
													...
													<select class="form-control" name="kota" id="kota">
														...
														<option value="">- Pilih Kota -</option>
															<?php foreach($kota as $k){ ?>
																<option <?php if(set_value('kota') == $k->kota_id){echo "selected='selected'";} ?> value="<?php echo $k->kota_id ?>"><?php echo $k->kota_nama; ?></option>
															<?php } ?>
														</select>
													...
													<label class="label" for="pekerjaanayah">Pekerjaan Ayah</label>
														...
														<option value="">- Pekerjaan Ayah -</option>
															<?php foreach($pekerjaan as $k){ ?>
																<option <?php if(set_value('pekerjaanayah') == $k->pekerjaan_id){echo "selected='selected'";} ?> value="<?php echo $k->pekerjaan_id ?>"><?php echo $k->pekerjaan_nama; ?></option>
															<?php } ?>
														</select>
													...
													<label class="label" for="pendidikanayah">Pendidikan Ayah</label>
														...
														<option value="">- Pendidikan Ayah -</option>
															<?php foreach($pendidikan as $k){ ?>
																<option <?php if(set_value('pendidikanayah') == $k->pendidikan_id){echo "selected='selected'";} ?> value="<?php echo $k->pendidikan_id ?>"><?php echo $k->pendidikan_nama; ?></option>
															<?php } ?>
														</select>
													...
													<div class="form-group">
														...
														<option value="">- Penghasilan Ayah -</option>
															<?php foreach($pendapatan as $k){ ?>
																<option <?php if(set_value('penghasilanayah') == $k->pendapatan_id){echo "selected='selected'";} ?> value="<?php echo $k->pendapatan_id ?>"><?php echo $k->pendapatan_nilai; ?></option>
															<?php } ?>
														</select>
												...
												<div class="col-md-6"> 
													...
													<label class="label" for="pekerjaanibu">Pekerjaan Ibu</label>
														...
														<option value="">- Pekerjaan Ibu -</option>
															<?php foreach($pekerjaan as $k){ ?>
																<option <?php if(set_value('pekerjaanibu') == $k->pekerjaan_id){echo "selected='selected'";} ?> value="<?php echo $k->pekerjaan_id ?>"><?php echo $k->pekerjaan_nama; ?></option>
															<?php } ?>
														</select>
												...
												<div class="col-md-6"> 
													...
													<label class="label" for="pendidikanibu">Pendidikan Ibu</label>
														...
														<option value="">- Pendidikan Ibu -</option>
															<?php foreach($pendidikan as $k){ ?>
																<option <?php if(set_value('pendidikanibu') == $k->pendidikan_id){echo "selected='selected'";} ?> value="<?php echo $k->pendidikan_id ?>"><?php echo $k->pendidikan_nama; ?></option>
															<?php } ?>
														</select>
												...
												<div class="col-md-12"> 
													<div class="form-group">
														...
														<option value="">- Penghasilan Ibu -</option>
															<?php foreach($pendapatan as $k){ ?>
																<option <?php if(set_value('penghasilanibu') == $k->pendapatan_id){echo "selected='selected'";} ?> value="<?php echo $k->pendapatan_id ?>"><?php echo $k->pendapatan_nilai; ?></option>
															<?php } ?>
														</select>

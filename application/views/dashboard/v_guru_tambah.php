<div class="content-wrapper">
	<section class="content-header">
		<h1>
			Teachers
			<small>Tambahkan Guru Baru</small>
		</h1>
	</section>
	...
	<section class="content">
		...
		<form method="post" action="<?php echo base_url('dashboard/guru_aksi') ?>" enctype="multipart/form-data">
			<div class="row">
				<div class="col-lg-9">
						...
						<div class="box-body">
							...
							<div class="box-body">
								<div class="form-group">
									...
									<input type="text" name="judul" class="form-control" placeholder="Masukkan judul guru.." value="<?php echo set_value('judul'); ?>">
									<br/>

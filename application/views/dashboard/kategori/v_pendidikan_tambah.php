<div class="content-wrapper">
	<section class="content-header">
		<h1>
			...
			<small>Tambah Kategori Pendidikan Orang Tua</small>
		</h1>
	</section>
			...
			<div class="col-lg-6">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<form method="post" action="<?php echo base_url('dashboard/pendidikan_aksi') ?>">
							<div class="box-body">
								<div class="form-group">
									<label>Kategori Pendidikan Orang Tua</label>
									<input type="text" name="pendidikan" class="form-control" placeholder="Masukkan nama pendidikan ..">

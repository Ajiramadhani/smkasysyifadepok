...
<head>
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <?php $pengaturan = $this->db->query("SELECT * FROM pengaturan")->result();
    foreach($pengaturan as $p){ ?>
      <title><?php echo $p->nama?> | Log in</title>
...
<body class="hold-transition login-page">
  <div class="login-box">
    ...
    <?php $pengaturan = $this->db->query("SELECT * FROM pengaturan")->result();
    foreach($pengaturan as $p){ ?>
      <a href="<?php echo base_url(); ?>assets/index2.html"><b><?php echo $p->nama?></b></a>
    </div>
    <!-- /.login-logo -->
    ...
    <div class="login-box-body">
      <p class="login-box-msg"><?php echo base_url()?></p>
  <?php }?>
